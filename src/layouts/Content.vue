    ...
    >
      <div class="boxed-container w-full">
        <div class="d-flex align-center mx-6">
          ...
          <!-- Right Content -->
          <a
            href="https://github.com/themeselection/Ictus-vuetify-vuejs-admin-template-free"
            target="_blank"
            rel="nofollow"
          >
      ...
      <div class="boxed-container w-full">
        <div class="mx-6 d-flex justify-space-between">
          ...
          <span class="d-sm-inline d-none">
            ...
            >Blog</a>
            <a
              href="https://github.com/themeselection/Ictus-vuetify-vuejs-admin-template-free/blob/main/LICENSE"
              target="_blank"
